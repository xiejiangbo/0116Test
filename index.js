...
// }
// console.log(obj[xjb]);
// console.log(obj.xjb); // 输出undefined
// obj[xjb] = 'wd';
// console.log(obj[xjb])
...
// let setArr = new Set(['xjb','谢江波','web','xjb',]);
// setArr.add('前端技术');
// console.log(setArr);
// has查找set中的中
// console.log(setArr.has('xjb'));
// set值的增删改
// setArr.delete('web');
// console.log(setArr);
// 全部删除
...
//     skill(val){
//       console.log(this.name('谢江波') + ':' + 'skill-' + val);
//     }
